Shader "Custom/Shader_Comstom_Lit"
{
    Properties
    {
        ...
        _OutlineWaveStrength("Outline Wave Strength", Float) = 0.01
    ...
    SubShader
    {
        ...
        pass
        {
            ...
            v2f vert (a2v v)
            {
                ...
                float width = _OutlineWidth + wave * _OutlineWaveStrength;
                width = max(0.0, width);
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.MyLitShaderGUI"
}
