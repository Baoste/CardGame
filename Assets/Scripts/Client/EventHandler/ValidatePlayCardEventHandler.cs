...
public class ValidatePlayCardEventHandler : IEventProcess, IEventHandler
{
    public bool Handle(NetEvent ev)
{
    var payload = JsonConvert.DeserializeObject<ValidatePlayCardEvent>(ev.jsonData); // need change
