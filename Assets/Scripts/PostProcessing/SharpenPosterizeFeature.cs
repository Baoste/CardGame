...
public class SharpenPosterizeFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class SharpenPosterizePass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref tempRT, desc, FilterMode.Bilinear, TextureWrapMode.Clamp, name: "_SharpenPosterizeTempRT");
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            CommandBuffer cmd = CommandBufferPool.Get("SharpenPosterize Pass");
